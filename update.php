    ...
    <style>
        ...
        * {
        ...
        .btn-main:hover {
            ...
            border-color: #c45a5b;
            box-shadow: -2px 2px 14px rgba(168, 72, 73, 0.35);
        }
        ...
        .wo_update_changelog li {
            margin-bottom: 7px;
            max-height: 20px;
            overflow: hidden;
        }

        .wo_update_changelog li span {
            padding: 2px 7px;
            font-size: 12px;
            margin-right: 4px;
            border-radius: 2px;
        ...
        .wo_update_changelog li span.added {
            background-color: #4CAF50;
            color: white;
        }

        .wo_update_changelog li span.changed {
            background-color: #e62117;
            color: white;
        }

        .wo_update_changelog li span.improved {
            background-color: #9C27B0;
            color: white;
        }

        .wo_update_changelog li span.compressed {
            background-color: #795548;
            color: white;
        }

        .wo_update_changelog li span.fixed {
                        ...
                        <?php if ($updated == true) { ?>
                            <div>
                                <div class="empty_state">
                                    ...
                                    <p>Congratulations, you have successfully updated your site. Thanks for choosing Skyblue.</p>
                                    <br>
        ...
        $.post('?update', {
            ...
            if (queriesLength > count) {
                ...
                $.post('?run_lang', {
                    ...
                    $('.wo_update_changelog').append('<li><span class="fixed">Finished!</span> ~$ Congratulations! you have successfully updated your site. Thanks for choosing Skyblue.</li>');
